...
NbufferT = [
    # x     Info                                                color info        y                  z
     뒤에 "REDACTED_OPENAI_KEY"로 치환   value y2 Info2                            name z2         Name Value
     뒤에 "REDACTED_OPENAI_KEY"로 치환            name   value    y3       z3
...
############################################################
 뒤에 "REDACTED_OPENAI_KEY"로 치환Creation tests
############################################################
...
############################################################
 뒤에 "REDACTED_OPENAI_KEY"로 치환Reading tests
############################################################
