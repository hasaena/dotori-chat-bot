...
class TestEinsum:
    ...
    def test_einsum_fixedstridebug(self):
        ...
        # NOTE: This test is triggered by the fact that the default buffersize,
         뒤에 "REDACTED_OPENAI_KEY"로 치환   used by einsum, is 8192, and 3*2731 = 8193, is larger than that
         뒤에 "REDACTED_OPENAI_KEY"로 치환   and results in a mismatch between the buffering and the
         뒤에 "REDACTED_OPENAI_KEY"로 치환   striding for operand A.
