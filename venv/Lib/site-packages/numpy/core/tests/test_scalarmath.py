...
#class TestRepr:
 뒤에 "REDACTED_OPENAI_KEY"로 치환def test_repr(self):
 뒤에 "REDACTED_OPENAI_KEY"로 치환    for t in types:
 뒤에 "REDACTED_OPENAI_KEY"로 치환        val = t(1197346475.0137341)
 뒤에 "REDACTED_OPENAI_KEY"로 치환        val_repr = repr(val)
 뒤에 "REDACTED_OPENAI_KEY"로 치환        val2 = eval(val_repr)
 뒤에 "REDACTED_OPENAI_KEY"로 치환        assert_equal( val, val2 )
