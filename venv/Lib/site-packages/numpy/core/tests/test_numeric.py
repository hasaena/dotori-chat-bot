...
class TestTypes:
    ...
    def test_coercion(self):
        ...
        # Use-case: float/complex scalar * bool/int8 array
         뒤에 "REDACTED_OPENAI_KEY"로 치환       shouldn't narrow the float/complex type
        ...
        # Use-case: (1-t)*a, where 't' is a boolean array and 'a' is
         뒤에 "REDACTED_OPENAI_KEY"로 치환        a float32, shouldn't promote to float64
        #
...
class TestNonzero:
    ...
    def test_nonzero_onedim(self):
        ...
        # x = np.array([(1, 2), (0, 0), (1, 1), (-1, 3), (0, 7)],
         뒤에 "REDACTED_OPENAI_KEY"로 치환          dtype=[('a', 'i4'), ('b', 'i2')])
