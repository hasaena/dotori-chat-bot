...
class TestMultivariateHypergeometric:
    ...
    # Cases for nsample:
     뒤에 "REDACTED_OPENAI_KEY"로 치환 nsample < 10
     뒤에 "REDACTED_OPENAI_KEY"로 치환 10 <= nsample < colors.sum()/2
     뒤에 "REDACTED_OPENAI_KEY"로 치환 colors.sum()/2 < nsample < colors.sum() - 10
     뒤에 "REDACTED_OPENAI_KEY"로 치환 colors.sum() - 10 < nsample < colors.sum()
