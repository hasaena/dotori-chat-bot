...
class ModuleTester:
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'sin', 'cos', 'tan',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'arcsin', 'arccos', 'arctan',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'sinh', 'cosh', 'tanh',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'arcsinh',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'arccosh',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'arctanh',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'absolute', 'fabs', 'negative',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              # 'nonzero', 'around',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'floor', 'ceil',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              # 'sometrue', 'alltrue',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'logical_not',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'add', 'subtract', 'multiply',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'divide', 'true_divide', 'floor_divide',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'remainder', 'fmod', 'hypot', 'arctan2',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'equal', 'not_equal', 'less_equal', 'greater_equal',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'less', 'greater',
 뒤에 "REDACTED_OPENAI_KEY"로 치환              'logical_and', 'logical_or', 'logical_xor',
                  ]:
            try:
