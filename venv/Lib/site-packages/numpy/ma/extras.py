...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    aux.sort()
    auxf = aux.filled()
 뒤에 "REDACTED_OPENAI_KEY"로 치환flag = ediff1d( aux, to_end = 1, to_begin = 1 ) == 0
    flag = ma.concatenate(([True], (auxf[1:] != auxf[:-1]), [True]))
 뒤에 "REDACTED_OPENAI_KEY"로 치환flag2 = ediff1d( flag ) == 0
    flag2 = (flag[1:] == flag[:-1])
    return aux[flag2]
...
###############################################################################
 뒤에 "REDACTED_OPENAI_KEY"로 치환                            Covariance                                   #
###############################################################################
...
###############################################################################
 뒤에 "REDACTED_OPENAI_KEY"로 치환                          Polynomial fit                                 #
###############################################################################
