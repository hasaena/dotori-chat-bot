    ...
    async def _receive_event(
        ...
        while True:
            ...
            if event is h11.NEED_DATA:
                ...
                #
                 뒤에 "REDACTED_OPENAI_KEY"로 치환 httpcore.RemoteProtocolError: can't handle event type
                 뒤에 "REDACTED_OPENAI_KEY"로 치환 ConnectionClosed when role=SERVER and state=SEND_RESPONSE
                #
