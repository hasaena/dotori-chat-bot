...
class ClearMLCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def _create_session_analysis_df(self) -> Any:
        ...
        # session_analysis_df["chat_html"] = session_analysis_df[
         뒤에 "REDACTED_OPENAI_KEY"로 치환 ["prompts", "output"]
        # ].apply(
         뒤에 "REDACTED_OPENAI_KEY"로 치환 lambda row: construct_html_from_prompt_and_generation(
         뒤에 "REDACTED_OPENAI_KEY"로 치환     row["prompts"], row["output"]
         뒤에 "REDACTED_OPENAI_KEY"로 치환 ),
         뒤에 "REDACTED_OPENAI_KEY"로 치환 axis=1,
        # )
