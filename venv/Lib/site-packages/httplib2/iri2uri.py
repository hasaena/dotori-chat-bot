...
# ucschar = %xA0-D7FF / %xF900-FDCF / %xFDF0-FFEF
 뒤에 "REDACTED_OPENAI_KEY"로 치환     / %x10000-1FFFD / %x20000-2FFFD / %x30000-3FFFD
 뒤에 "REDACTED_OPENAI_KEY"로 치환     / %x40000-4FFFD / %x50000-5FFFD / %x60000-6FFFD
 뒤에 "REDACTED_OPENAI_KEY"로 치환     / %x70000-7FFFD / %x80000-8FFFD / %x90000-9FFFD
 뒤에 "REDACTED_OPENAI_KEY"로 치환     / %xA0000-AFFFD / %xB0000-BFFFD / %xC0000-CFFFD
 뒤에 "REDACTED_OPENAI_KEY"로 치환     / %xD0000-DFFFD / %xE1000-EFFFD
