...
#
 뒤에 "REDACTED_OPENAI_KEY"로 치환  https://www.apache.org/licenses/LICENSE-2.0
#
...
class PrivateKey(AbstractKey):
    ...
    def _load_pkcs1_der(cls, keyfile: bytes) -> "PrivateKey":
        ...
        # RSAPrivateKey ::= SEQUENCE {
         뒤에 "REDACTED_OPENAI_KEY"로 치환 version           Version,
         뒤에 "REDACTED_OPENAI_KEY"로 치환 modulus           INTEGER,  -- n
         뒤에 "REDACTED_OPENAI_KEY"로 치환 publicExponent    INTEGER,  -- e
         뒤에 "REDACTED_OPENAI_KEY"로 치환 privateExponent   INTEGER,  -- d
         뒤에 "REDACTED_OPENAI_KEY"로 치환 prime1            INTEGER,  -- p
         뒤에 "REDACTED_OPENAI_KEY"로 치환 prime2            INTEGER,  -- q
         뒤에 "REDACTED_OPENAI_KEY"로 치환 exponent1         INTEGER,  -- d mod (p-1)
         뒤에 "REDACTED_OPENAI_KEY"로 치환 exponent2         INTEGER,  -- d mod (q-1)
         뒤에 "REDACTED_OPENAI_KEY"로 치환 coefficient       INTEGER,  -- (inverse of q) mod p
         뒤에 "REDACTED_OPENAI_KEY"로 치환 otherPrimeInfos   OtherPrimeInfos OPTIONAL
        # }
