...
class ResourceMethodParameters(object):
    ...
    def __init__(self, method_desc):
        ...
        # TODO(dhermes): Change path_params to a list if the extra URITEMPLATE
         뒤에 "REDACTED_OPENAI_KEY"로 치환            parsing is gotten rid of.
    ...
    def set_parameters(self, method_desc):
        ...
        # TODO(dhermes): Determine if this is still necessary. Discovery based APIs
         뒤에 "REDACTED_OPENAI_KEY"로 치환            should have all path parameters already marked with
         뒤에 "REDACTED_OPENAI_KEY"로 치환            'location: path'.
