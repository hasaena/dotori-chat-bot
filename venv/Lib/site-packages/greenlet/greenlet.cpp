...
#ifdef __clang__
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic push
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic ignored "-Wmissing-field-initializers"
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic ignored "-Wwritable-strings"
#elif defined(__GNUC__)
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma GCC diagnostic push
//  warning: ISO C++ forbids converting a string constant to ‘char*’
// (The python APIs aren't const correct and accept writable char*)
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma GCC diagnostic ignored "-Wwrite-strings"
#endif
...
#ifdef __clang__
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic pop
#elif defined(__GNUC__)
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma GCC diagnostic pop
#endif
