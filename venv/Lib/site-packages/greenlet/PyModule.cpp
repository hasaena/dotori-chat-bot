...
using greenlet::ThreadState;
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic ignored "-Wunused-function"
 뒤에 "REDACTED_OPENAI_KEY"로 치환pragma clang diagnostic ignored "-Wunused-variable"
#endif
