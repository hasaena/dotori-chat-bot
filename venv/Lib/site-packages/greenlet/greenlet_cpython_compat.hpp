...
#include "Python.h"
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY310 1
#else
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY310 0
#endif
...
*/
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_USE_CFRAME 1
#else
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_USE_CFRAME 0
#endif
...
*/
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY311 1
#else
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY311 0
#endif


#if PY_VERSION_HEX >= 0x30C0000
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY312 1
#else
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY312 0
#endif

#if PY_VERSION_HEX >= 0x30D0000
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY313 1
#else
 뒤에 "REDACTED_OPENAI_KEY"로 치환define GREENLET_PY313 0
#endif

#ifndef Py_SET_REFCNT
/* Py_REFCNT and Py_SIZE macros are converted to functions
https://bugs.python.org/issue39573 */
 뒤에 "REDACTED_OPENAI_KEY"로 치환define Py_SET_REFCNT(obj, refcnt) Py_REFCNT(obj) = (refcnt)
#endif
...
*/
 뒤에 "REDACTED_OPENAI_KEY"로 치환ifdef Py_REF_DEBUG
 뒤에 "REDACTED_OPENAI_KEY"로 치환  if GREENLET_PY312
 뒤에 "REDACTED_OPENAI_KEY"로 치환     define _Py_DEC_REFTOTAL
 뒤에 "REDACTED_OPENAI_KEY"로 치환  else
 뒤에 "REDACTED_OPENAI_KEY"로 치환    define _Py_DEC_REFTOTAL _Py_RefTotal--
 뒤에 "REDACTED_OPENAI_KEY"로 치환  endif
 뒤에 "REDACTED_OPENAI_KEY"로 치환else
 뒤에 "REDACTED_OPENAI_KEY"로 치환    define _Py_DEC_REFTOTAL
 뒤에 "REDACTED_OPENAI_KEY"로 치환endif
#endif
...
// The official version only became available in 3.9
 뒤에 "REDACTED_OPENAI_KEY"로 치환define PyObject_GC_IsTracked(o) _PyObject_GC_IS_TRACKED(o)
#endif
