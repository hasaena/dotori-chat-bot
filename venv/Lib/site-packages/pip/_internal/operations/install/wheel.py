...
def message_about_scripts_not_on_PATH(scripts: Sequence[str]) -> Optional[str]:
    ...
    # If an executable sits with sys.executable, we don't warn for it.
     뒤에 "REDACTED_OPENAI_KEY"로 치환 This covers the case of venv invocations without activating the venv.
...
def get_console_script_specs(console: Dict[str, str]) -> List[str]:
    ...
    #   - pipX.Y, pipX, easy_install-X.Y will be generated and installed. Note
     뒤에 "REDACTED_OPENAI_KEY"로 치환 that this option is technically if ENSUREPIP_OPTIONS is set and is
     뒤에 "REDACTED_OPENAI_KEY"로 치환 not altinstall
    # DEFAULT
    #   - The default behavior is to install pip, pipX, pipX.Y, easy_install
     뒤에 "REDACTED_OPENAI_KEY"로 치환 and easy_install-X.Y.
