...
class PyPIJSONLocator(Locator):
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환        for info in urls:
 뒤에 "REDACTED_OPENAI_KEY"로 치환            md.source_url = info['url']
 뒤에 "REDACTED_OPENAI_KEY"로 치환            dist.digest = self._get_digest(info)
 뒤에 "REDACTED_OPENAI_KEY"로 치환            dist.locator = self
 뒤에 "REDACTED_OPENAI_KEY"로 치환            for info in urls:
 뒤에 "REDACTED_OPENAI_KEY"로 치환                url = info['url']
 뒤에 "REDACTED_OPENAI_KEY"로 치환                result['urls'].setdefault(md.version, set()).add(url)
 뒤에 "REDACTED_OPENAI_KEY"로 치환                result['digests'][url] = self._get_digest(info)
