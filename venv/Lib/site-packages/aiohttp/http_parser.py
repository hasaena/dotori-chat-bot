...
#
 뒤에 "REDACTED_OPENAI_KEY"로 치환 method = token
 뒤에 "REDACTED_OPENAI_KEY"로 치환 tchar = "!" / "#" / "$" / "%" / "&" / "'" / "*" / "+" / "-" / "." /
 뒤에 "REDACTED_OPENAI_KEY"로 치환         "^" / "_" / "`" / "|" / "~" / DIGIT / ALPHA
 뒤에 "REDACTED_OPENAI_KEY"로 치환 token = 1*tchar
