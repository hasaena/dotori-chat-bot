...
#
 뒤에 "REDACTED_OPENAI_KEY"로 치환  License: MIT
 뒤에 "REDACTED_OPENAI_KEY"로 치환  Author:  See AUTHORS.txt
#
...
if __name__ == '__main__':
 ...
 뒤에 "REDACTED_OPENAI_KEY"로 치환suite = suite()
 뒤에 "REDACTED_OPENAI_KEY"로 치환unittest.TextTestRunner(verbosity=2).run(suite)
