...
class Client:
    ...
    def get_oauth_params(self, request):
        ...
        # 4.1.1. When to include the body hash
         뒤에 "REDACTED_OPENAI_KEY"로 치환*  [...] MUST NOT include an oauth_body_hash parameter on requests with form-encoded request bodies
         뒤에 "REDACTED_OPENAI_KEY"로 치환*  [...] SHOULD include the oauth_body_hash parameter on all other requests.
    ...
    def sign(self, uri, http_method='GET', body=None, headers=None, realm=None):
        ...
        if multipart and has_params:
         ...
         뒤에 "REDACTED_OPENAI_KEY"로 치환   [W3C.REC-html40-19980424].
        ...
        # o  The HTTP request entity-header includes the "Content-Type" header
         뒤에 "REDACTED_OPENAI_KEY"로 치환field set to "application/x-www-form-urlencoded".
