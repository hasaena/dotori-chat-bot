...
class PropRegistry(PathRegistry):
    ...
    def __init__(self, parent, prop):
        ...
        if not insp.is_aliased_class or insp._use_mapper_path:
            ...
            #   뒤에 "REDACTED_OPENAI_KEY"로 치환test_subqueryload_on_subclass_uses_path_correctly
            ...
            #  sess.query(RegularEntity).options(
             뒤에 "REDACTED_OPENAI_KEY"로 치환   someload(RegularEntity.foos.of_type(wp))
             뒤에 "REDACTED_OPENAI_KEY"로 치환   .someload(wp.SubFoo.bar)
            #   )
            #
...
class AbstractEntityRegistry(PathRegistry):
    ...
    def __init__(self, parent, entity):
        ...
        # elif not parent.path and self.is_aliased_class:
         뒤에 "REDACTED_OPENAI_KEY"로 치환 self.natural_path = (self.entity._generate_cache_key()[0], )
        else:
