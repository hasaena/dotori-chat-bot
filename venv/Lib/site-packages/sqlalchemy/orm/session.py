...
class Session(_SessionClassMethods):
    ...
    def _flush(self, objects=None):
        ...
        try:
            ...
            # useful assertions:
            # if not objects:
             뒤에 "REDACTED_OPENAI_KEY"로 치환assert not self.identity_map._modified
            # else:
             뒤에 "REDACTED_OPENAI_KEY"로 치환assert self.identity_map._modified == \
             뒤에 "REDACTED_OPENAI_KEY"로 치환        self.identity_map._modified.difference(objects)
