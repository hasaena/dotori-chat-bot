...
class RelationshipProperty(StrategizedProperty):
    ...
    def _add_reverse_property(self, key):
        ...
        # 2. self.viewonly==True and other.viewonly==False and
         뒤에 "REDACTED_OPENAI_KEY"로 치환other.sync_backref==None -> warn sync_backref=False, set to False
        ...
        # 4. other.viewonly==True and self.viewonly==False and
         뒤에 "REDACTED_OPENAI_KEY"로 치환self.sync_backref==None -> warn sync_backref=False, set to False
