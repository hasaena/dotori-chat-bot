    ...
    def collect_fields(self, model_config: 'ModelConfigData') -> List['PydanticModelField']:
        ...
        for stmt in cls.defs.body:
            ...
            # if lhs.name == '__config__':  # BaseConfig not well handled; I'm not sure why yet
             뒤에 "REDACTED_OPENAI_KEY"로 치환 continue
...
def add_method(
    ...
    # elif is_staticmethod:
     뒤에 "REDACTED_OPENAI_KEY"로 치환 first = []
    else:
        self_type = self_type or fill_typevars(info)
    ...
    if is_classmethod:  # or is_staticmethod:
        ...
        # else:
         뒤에 "REDACTED_OPENAI_KEY"로 치환 v.is_staticmethod = True
         뒤에 "REDACTED_OPENAI_KEY"로 치환 dec = Decorator(func, [NameExpr('staticmethod')], v)
