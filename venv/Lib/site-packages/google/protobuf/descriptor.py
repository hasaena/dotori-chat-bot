...
if _USE_C_DESCRIPTORS:
  # This metaclass allows to override the behavior of code like
   뒤에 "REDACTED_OPENAI_KEY"로 치환 isinstance(my_descriptor, FieldDescriptor)
...
class _NestedDescriptorBase(DescriptorBase):
  ...
  def __init__(self, options, options_class_name, name, full_name,
    ...
    # TODO: Add function to calculate full_name instead of having it in
     뒤에 "REDACTED_OPENAI_KEY"로 치환         memory?
...
class Descriptor(_NestedDescriptorBase):
  ...
  def __init__(self, name, full_name, filename, containing_type, fields,
    ...
    #   2. Clients can easily iterate over all fields with the terse
     뒤에 "REDACTED_OPENAI_KEY"로 치환  syntax: for f in descriptor.fields: ...
    self.fields = fields
...
#   * If you specify a repeated field, you should not be allowed
 뒤에 "REDACTED_OPENAI_KEY"로 치환 to specify a default value.
