...
class ExtendedOperation(polling.PollingFuture):
    ...
    * error_message: str
    ...
    # class MyOperation(proto.Message):
     뒤에 "REDACTED_OPENAI_KEY"로 치환 moniker = proto.Field(proto.STRING, number=1)
     뒤에 "REDACTED_OPENAI_KEY"로 치환 status_msg = proto.Field(proto.STRING, number=2)
     뒤에 "REDACTED_OPENAI_KEY"로 치환 optional http_error_code = proto.Field(proto.INT32, number=3)
     뒤에 "REDACTED_OPENAI_KEY"로 치환 optional http_error_msg = proto.Field(proto.STRING, number=4)
    #
