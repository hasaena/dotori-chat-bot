...
#   - Cons: Might produce less informative errors in the case of conflicting
 뒤에 "REDACTED_OPENAI_KEY"로 치환 TypeVars e.g. `attr.ib(default='bad', type=int)`
# 2) Callable[..., _T]
#   - Pros: Better error messages than #1 for conflicting TypeVars
#   - Cons: Terrible error messages for validator checks.
#   e.g. attr.ib(type=int, validator=validate_str)
 뒤에 "REDACTED_OPENAI_KEY"로 치환    -> error: Cannot infer function type argument
...
# `attr` lies about its return type to make the following possible:
 뒤에 "REDACTED_OPENAI_KEY"로 치환 attr()    -> Any
 뒤에 "REDACTED_OPENAI_KEY"로 치환 attr(8)   -> int
 뒤에 "REDACTED_OPENAI_KEY"로 치환 attr(validator=<some callable>)  -> Whatever the callable expects.
# This makes this type of assignments possible:
 뒤에 "REDACTED_OPENAI_KEY"로 치환 x: int = attr(8)
#
