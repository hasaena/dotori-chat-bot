...
class bdist_rpm(Command):
    ...
    def _make_spec_file(self):  # noqa: C901
        ...
        # for locale in self.summaries.keys():
         뒤에 "REDACTED_OPENAI_KEY"로 치환spec_file.append('Summary(%s): %s' % (locale,
         뒤에 "REDACTED_OPENAI_KEY"로 치환                                      self.summaries[locale]))
        ...
        # for locale in self.descriptions.keys():
         뒤에 "REDACTED_OPENAI_KEY"로 치환spec_file.extend([
         뒤에 "REDACTED_OPENAI_KEY"로 치환    '',
         뒤에 "REDACTED_OPENAI_KEY"로 치환    '%description -l ' + locale,
         뒤에 "REDACTED_OPENAI_KEY"로 치환    self.descriptions[locale],
         뒤에 "REDACTED_OPENAI_KEY"로 치환    ])
