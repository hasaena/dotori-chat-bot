        ...
        for obj in objects:
            ...
            if ext in self._c_extensions:
                ...
                #   * '-h dir' specifies the directory for the
                 뒤에 "REDACTED_OPENAI_KEY"로 치환 generated include file
                #   * '-r dir' specifies the target directory of the
                 뒤에 "REDACTED_OPENAI_KEY"로 치환 generated RC file and the binary message resource
                 뒤에 "REDACTED_OPENAI_KEY"로 치환 it includes
                #
