...
class _Utf8EncodingNeeded(SetuptoolsDeprecationWarning):
    ...
    """
    # TODO: Add a deadline?
     뒤에 "REDACTED_OPENAI_KEY"로 치환   Will we be able to remove this?
     뒤에 "REDACTED_OPENAI_KEY"로 치환   The question comes to mind mainly because of sdists that have been produced
     뒤에 "REDACTED_OPENAI_KEY"로 치환   by old versions of setuptools and published to PyPI...
