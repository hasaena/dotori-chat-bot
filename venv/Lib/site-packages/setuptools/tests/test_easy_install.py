...
def test_editable_user_and_build_isolation(setup_context, monkeypatch, tmp_path):
    ...
    # 1. setuptools/command/easy_install.py:create_home_path
     뒤에 "REDACTED_OPENAI_KEY"로 치환tries creating directories in $HOME.
     뒤에 "REDACTED_OPENAI_KEY"로 치환Given::
     뒤에 "REDACTED_OPENAI_KEY"로 치환    self.config_vars['DESTDIRS'] = (
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10 "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib/python3.9 "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib/python3.9/lib-dynload")
     뒤에 "REDACTED_OPENAI_KEY"로 치환`create_home_path` will::
     뒤에 "REDACTED_OPENAI_KEY"로 치환    makedirs(
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10 "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib/python3.9 "
     뒤에 "REDACTED_OPENAI_KEY"로 치환        "/home/user/.pyenv/versions/3.9.10/lib/python3.9/lib-dynload")
    ...
    # 2. We are going to force `site` to update site.USER_BASE and site.USER_SITE
     뒤에 "REDACTED_OPENAI_KEY"로 치환To point inside our new home
