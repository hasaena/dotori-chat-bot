...
def get_comma_header(headers: Headers, name: bytes) -> List[bytes]:
    ...
    #
     뒤에 "REDACTED_OPENAI_KEY"로 치환Transfer-Encoding: foo; options="1,2", chunked
    #
    # and should be parsed as
    #
     뒤에 "REDACTED_OPENAI_KEY"로 치환foo; options="1,2"
     뒤에 "REDACTED_OPENAI_KEY"로 치환chunked
    #
    # but this naive function will parse it as
    #
     뒤에 "REDACTED_OPENAI_KEY"로 치환foo; options="1
     뒤에 "REDACTED_OPENAI_KEY"로 치환2"
     뒤에 "REDACTED_OPENAI_KEY"로 치환chunked
    #
