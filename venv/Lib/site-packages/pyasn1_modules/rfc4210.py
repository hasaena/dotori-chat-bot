...
class PKIBody(univ.Choice):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
         ...
         뒤에 "REDACTED_OPENAI_KEY"로 치환    namedtype.NamedType('nested', NestedMessageContent().subtype(
         뒤에 "REDACTED_OPENAI_KEY"로 치환        explicitTag=tag.Tag(tag.tagClassContext,tag.tagFormatConstructed,20)
